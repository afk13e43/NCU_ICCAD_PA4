    ...
    void solve()
    {
        ...
        while (T > T_min)
        {
            ...
            cout << "Temp: " << fixed << setprecision(2) << T
                 ...
                 << ", Round Elapsed time: " << fixed << setprecision(2) << get_sa_elapsed_time() << " s" << endl;
            if (get_sa_elapsed_time() * 2 > 600)
            {
                break;
            }
            if (get_elapsed_time() + get_sa_elapsed_time() > 590)
            {
                break;
            }
            T *= cooling_rate;
...
private:
    ...
    double calculate_cost()
    {
        ...
        return 1 * cost_AreaAR + 0 * inl_val;
    };
